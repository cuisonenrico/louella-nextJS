    ...
    <TooltipProvider>
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        <Tooltip><TooltipTrigger asChild>
          <Button variant="ghost" size="icon" className="size-11 md:size-8" aria-label="Previous day" onClick={() => onDateChange(dayjs(filterDate).subtract(1, 'day').format('YYYY-MM-DD'))}>
        ...
        <Tooltip><TooltipTrigger asChild>
          <Button variant="ghost" size="icon" className="size-11 md:size-8" aria-label="Next day" onClick={() => onDateChange(dayjs(filterDate).add(1, 'day').format('YYYY-MM-DD'))}>
